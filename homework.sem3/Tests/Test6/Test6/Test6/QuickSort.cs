...
namespace Test6
{
    public class QuickSort
    {
        ...
        public async Task<int[]> QuickSortMultiThread(int[] array, int start, int end)
        {
            ...
            int supportMember = await Task.Run(() => FindSupportMemberMultiThread(array, start, end));
            var t1 = Task.Run(() => QuickSortMultiThread(array, start, supportMember - 1));
            var t2 = Task.Run(() => QuickSortMultiThread(array, supportMember + 1, end));
