...
namespace MyNUnit_task4
{
    ...
    public class TestInfo
    {
        ...
        public TestInfo(Type type, MethodInfo testMethod, List<MethodInfo> beforeMethods, List<MethodInfo> afterMethods)
        {
        ...
        public void Run()
        {
            Parallel.ForEach(beforeMethods, m => m?.Invoke(type, null));
            ...
            Parallel.ForEach(afterMethods, m => m?.Invoke(type, null));
